...
//   Tips via CC: company collects them and must pay them back to me.
//   Tips via cash: already in my hand, not part of the settlement.
//   My due        = commission + CC tips.
...
function agg(entries) {
  ...
  const myDue     = a.myCommission + a.ccTip; // commission + tips collected via CC
